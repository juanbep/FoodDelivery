...
public class PlateService {
    ...
    public String CreatePlate(Plate parPlate) {
        ...
        if ( parPlate.getAtrNamePlate().isEmpty() || parPlate.getAtrPricePlate().isEmpty() || parPlate.getAtrDescriptionPlate().isEmpty() || parPlate.getAtrTypePlate().isEmpty()) {
