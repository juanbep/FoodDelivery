...
public class RestaurantServerSocket implements Runnable {
    ...
    public RestaurantServerSocket() {
        ...
        IRestaurantRepository restaurantRepository = Factory.getInstance().getRepository();
        restaurantService = new RestaurantService(restaurantRepository);

        IUserRepository userRepository = Factory.getInstance().getRepositoryUser();
        userService = new UserService(userRepository);

        IPlateRepository plateRepository = Factory.getInstance().getRepositoryDish();
    ...
    private void processPostPlate(Protocol protocolRequest) {
        ...
        objPlate.setAtrIdPlate(protocolRequest.getParameters().get(0).getValue());
        objPlate.setAtrNamePlate(protocolRequest.getParameters().get(1).getValue());
        objPlate.setAtrPricePlate(protocolRequest.getParameters().get(2).getValue());
        objPlate.setAtrDescriptionPlate(protocolRequest.getParameters().get(2).getValue());
